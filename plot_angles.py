...
if __name__ == '__main__':
    ...
    subjects_poses_path = 'C:/lsh/lab/TULIP_demo_code/TULIP_demo_code/ThreeSubjects_GaitPoses.pkl'
    plt_save_path = 'C:/lsh/lab/TULIP_demo_code/TULIP_demo_code/angles_plot.jpg'
